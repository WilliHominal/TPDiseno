...
import isi.dds.tp.view.CU01_AltaPoliza2;
import isi.dds.tp.view.CU01_DeclararHijo;
import isi.dds.tp.view.CU04_AltaCliente;

public class CU01_controller {
	...
	private CU01_controller instancia;
	private JFrame ventana;
	private JPanel panelAnterior;
	private String tituloAnterior = "";
	
	private CU01_AltaPoliza1 altaPoliza1;
	...
	private CU01_DeclararHijo declararHijo;
	
	public CU01_controller(JFrame ventana) {
		instancia = this;
	...
	private void setAltaPoliza1() {
		this.altaPoliza1 = new CU01_AltaPoliza1();
	...
	class ListenerBuscarCliente implements ActionListener{
		public void actionPerformed(ActionEvent e) {
			try {
				CU17_controller a = new CU17_controller(ventana);	
	...
	public void setDeclararHijos() {
		declararHijo = new CU01_DeclararHijo();
