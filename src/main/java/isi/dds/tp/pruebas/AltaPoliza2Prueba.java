...
public class AltaPoliza2Prueba extends JPanel  {
	...
	public AltaPoliza2Prueba(JFrame ventana, Object[] tema) {
	...
	public void inicializarTema(Color colorBoton, Color colorFondoPantalla, Color colorFondoTexto, Color borde, Font letra, Font letraTitulo) {
		...
		*/
		...
		tablaPagos.setBorder(new LineBorder(borde));
